    ...
    const onMultiImagesDrop = (acceptedFiles) => {
        const validFiles = acceptedFiles.filter((file) => {
            if (file.size > 5 * 1024 * 1024) {
                toast.error(`${file.name} exceeds 5MB limit and will skipped`);
                return false;
            }
            return true;
        });
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className='space-y-6' >
                                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                                    ...
                                    <div className='space-y-2'>
                                        ...
                                        <Input id='year' {...register("year")} placeholder='e.g 2012' className={errors.year ? 'border-red-500' : ''} />
                                        {errors.year && (
                                    ...
                                    <div className='space-y-2'>
                                        ...
                                        <Input id='price' {...register("price")} placeholder='e.g 28000' className={errors.price ? 'border-red-500' : ''} />
                                        {errors.price && (
                                    ...
                                    <div className='space-y-2'>
                                        ...
                                        <Input id='mileage' {...register("mileage")} placeholder='e.g 15000' className={errors.mileage ? 'border-red-500' : ''} />
                                        {errors.mileage && (
                                    ...
                                    <div className='space-y-2'>
                                        ...
                                        <Select onValueChange={value => setValue("fuelType", value)} defaultValue={getValues("fuelType")}>
                                            <SelectTrigger className={errors.fuelType ? 'border-red-500' : ''}>
                                                <SelectValue placeholder="Selet fuel type" />
                                            </SelectTrigger>
                                            <SelectContent>
                                                {fuelTypes.map((type) => (
                                    ...
                                    <div className='space-y-2'>
                                        ...
                                        <Select onValueChange={value => setValue("transmission", value)} defaultValue={getValues("transmission")}>
                                            <SelectTrigger className={errors.transmission ? 'border-red-500' : ''}>
                                                <SelectValue placeholder="Selet Transmission" />
                                            </SelectTrigger>
                                            <SelectContent>
                                    ...
                                    <div className='space-y-2'>
                                        ...
                                        <Select onValueChange={value => setValue("bodyType", value)} defaultValue={getValues("bodyType")}>
                                            <SelectTrigger className={errors.bodyType ? 'border-red-500' : ''}>
                                                <SelectValue placeholder="Selet body type" />
                                            </SelectTrigger>
                                            <SelectContent>
                                                {bodyTypes.map((type) => (
                                                    <SelectItem key={type} value={type}>{type}</SelectItem>
                                    ...
                                    <div className='space-y-2'>
                                        ...
                                        <Select onValueChange={value => setValue("status", value)} defaultValue={getValues("status")}>
                                            <SelectTrigger>
                                                <SelectValue placeholder="Selet Status" />
                                            </SelectTrigger>
                                            <SelectContent>
                                ...
                                <div className='space-y-2'>
                                    ...
                                    <Input id='description' {...register("description")} placeholder='Enter a detailed description of the car...' className={`min-h-32 ${errors.description ? 'border-red-500' : ''}`} />
                                    {errors.description && (
                                    ...
                                    >
                                        ...
                                        <div className='flex flex-col items-center justify-center'>
                                            ...
                                            <p className='text-sm text-gray-600'>
                                                Drag 'n' drop or click to upload multiple images
                                            </p>
                                ...
                                <Button type="submit" className='w-full md:w-auto' disabled={addCarLoading}>
                                    {addCarLoading ? <><Loader2 className='mr-2 h-4 animate-spin' />Adding Car...</> : "Add Car"}
                                </Button>
                            </form>
                        </CardContent>
                    </Card>
                </TabsContent>
                <TabsContent value="ai" className='mt-6'>AI upload structure</TabsContent>
            </Tabs>
        </div>
    )
}
