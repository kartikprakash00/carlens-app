...
const CarDetails = ({ car, testDriveInfo }) => {
    ...
    const { loading: savingCar, fn: toggleSavedCarFn, data: toggleResult, error: toggleError } = useFetch(toggleSavedCar);
    ...
    const emiCalc = (car.price * 0.00375) * (Math.pow((1 + 0.00375), 60) / ((Math.pow((1 + 0.00375), 60) - 1)));
        ...
        <div>
            <div className='flex flex-col lg:flex-row gap-8'>
                <div className='w-full lg:w-7/12'>
                    <div className='aspect-video rounded-lg overflow-hidden relative mb-4'>
                        {car.images && car.images.length > 0 ? (
                            <Image src={car.images[currentImageIndex]} alt={`${car.year} ${car.make} ${car.model}`} fill className='object-cover' priority />
                        ) : (
                    ...
                    {car.images && car.images.length > 1 && (
                        <div className='flex gap-2 overflow-x-auto pb-2'>
                            {car.images.map((image, index) => (
                                ...
                                >
                                    <Image src={image} alt={`${car.year} ${car.make} ${car.model} - view ${index + 1}`} fill className='object-cover' />
                                </div>
                            ))}
                        </div>
                    )}
                    ...
                    <div className='flex mt-4 gap-4'>
                        <Button variant='outline' className={`flex items-center gap-2 flex-1 ${isWishlisted ? 'text-red-500' : ''}`} onClick={handleSaveCar} disabled={savingCar}>
                ...
                <div>
                    ...
                    <h1 className='text-4xl font-bold mb-1'>{car.year} {car.make} {car.model}</h1>
                    ...
                    <Dialog>
                        <DialogTrigger className='w-full text-start'>
                            <Card className='pt-5 cursor-pointer hover:bg-gray-100'>
                                <CardContent>
                        ...
                        <DialogContent>
                            <DialogHeader>
                                <DialogTitle>CarLens EMI Calculator</DialogTitle>
                    ...
                    <Card className='my-6'>
                        <CardContent className='p-4'>
                            ...
                            <a href="mailto:support@carlens.com">
                    ...
                    {car.status !== "SOLD" && car.status !== "UNAVAILABLE" && (
                        <Button className='w-full py-6 text-lg' disabled={testDriveInfo.userTestDrive} onClick={handleBookTestDrive}>
                            ...
                            {testDriveInfo.userTestDrive ? `Booked for ${format(new Date(testDriveInfo.userTestDrive.bookingDate), "EEEE, MMMM d, yyyy")}` : 'Book Test Drive'}
                        </Button>
                    )}
                </div>
            </div>
                    ...
                    <div className='flex flex-col md:flex-row gap-6 justify-between'>
                        <div className='flex items-start gap-3'>
                            ...
                            <div>
                                ...
                                <p className='text-gray-600 mt-1'>Phone: {testDriveInfo.dealership?.phone || "Not Available"}</p>
