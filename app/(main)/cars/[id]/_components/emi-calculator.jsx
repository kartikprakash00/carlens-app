...
const EmiCalculator = ({ price = 1000 }) => {
    ...
    const handInterestRateChange = (value) => {
            ...
            <div className='w-full'>
                ...
                <div className='space-y-4'>
                    <div className='relative'>
                        <h2 className='text-lg font-inter font-semibold text-gray-900 dark:text-white mb-3'>Vehicle Price</h2>
                    ...
                    <div className='bg-gray-50 dark:bg-gray-800 rounded-xl p-4'>
                        <h2 className='text-lg font-inter font-semibold text-gray-900 dark:text-white mb-3'>Down Payment</h2>
                        <div className='space-y-3'>
                            <div className='relative'>
                                <div className='absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none'>
                                    <span className='text-gray-700 dark:text-gray-300'>$</span>
                            ...
                            <input type="range" min='0' max={loanAmount} value={downPayment} onChange={(e) => handleDownPaymentChange(parseFloat(e.target.value))} className='w-full' />
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                        <div className='bg-gray-50 dark:bg-gray-800 rounded-xl p-4'>
                            <h2 className='text-lg font-inter font-semibold text-gray-900 dark:text-white mb-3'>Interest Rate</h2>
                            <div className='space-y-3'>
                                <div className='relative'>
                                    <input type="number"
                                        value={interestRate}
                                        onChange={(e) => handInterestRateChange(parseFloat(e.target.value))}
                                ...
                                <input type="range" min='0.1' max='25' step='0.1' value={interestRate} onChange={(e) => handInterestRateChange(parseFloat(e.target.value))} className='w-full' />
                            </div>
                        </div>

                        <div className='bg-gray-50 dark:bg-gray-800 rounded-xl p-4'>
                            <h2 className='text-lg font-inter font-semibold text-gray-900 dark:text-white mb-3'>Loan Term</h2>
                            <div className='space-y-3'>
                                <div className='relative'>
                                    <input type="number"
                                        value={loanTenure}
                                ...
                                <input type="range" min='1' max='8' value={loanTenure} onChange={(e) => handleLoanTenureChange(parseFloat(e.target.value))} className='w-full' />
                            </div>
                        </div>
                    </div>
                        ...
                        <div className='bg-gray-50 dark:bg-gray-800 rounded-xl p-4 mt-4'>
                            ...
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                                ...
                                <div className='bg-white dark:bg-gray-900 p-3 rounded-lg md:col-span-2'>
                                    <div className='text-sm font-inter text-gray-700 dark:text-gray-300'>
                                        Total Amount (Down Payment + Total Payment)
                                    </div>
                                    <div className='text-lg font-bold text-gray-900 dark:text-white mt-1'>
