...
const TestDriveForm = ({ car, testDriveInfo }) => {
    ...
    const { loading: bookingInProgress, fn: bookTestDriveFn, data: bookingResult, error: bookingError } = useFetch(bookTestDrive);
    ...
    useEffect(() => {
        if (bookingError) {
            toast.error(bookingError.message || "Failed to book your test drive. Please try again.");
        }
    }, [bookingError]);
            ...
            <div className='md:col-span-1'>
                <Card>
                    <CardContent className='p-6'>
                        <h2 className='text-xl font-bold mb-4'>Car Deatils</h2>

                        <div className='aspect-video rounded-lg overflow-hidden relative mb-4'>
                            {car.images && car.images.length > 0 ? (
                                <img src={car.images[0]} alt={`${car.year} ${car.make} ${car.model}`} className='object-cover w-full h-full' />
                            ) : (
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
                            <div className='space-y-2'>
                                ...
                                <Controller name='date' control={control} render={({ field }) => (
                                    <div>
                                        ...
                                        {errors.date && (
                                            <p className='text-sm font-medium text-red-500 mt-1'>{errors.date.message}</p>
                                        )}
                                    </div>
                                )} />
                            </div>
                            ...
                            <div className='space-y-2'>
                                ...
                                <Controller name='timeSlot' control={control} render={({ field }) => (
                                    <div>
                                        ...
                                        {errors.timeSlot && (
                                            <p className='text-sm font-medium text-red-500 mt-1'>{errors.timeSlot.message}</p>
                                        )}
                                    </div>
                                )} />
                            </div>
                            ...
                            <div className='space-y-2'>
                                ...
                                <Controller name='notes' control={control} render={({ field }) => (
                                    <Textarea {...field} placeholder='Any specific questions or requests for you test drive?' className='min-h-24' />
                                )} />
                            </div>
